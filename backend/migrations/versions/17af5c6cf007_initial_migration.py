...
def upgrade() -> None:
    ...
    op.create_table('shifts',
        ...
        sa.Column('type', sa.String(50), default='regular'),
    ...
    op.create_table('swap_requests',
        ...
        sa.Column('responder_id', sa.String(50), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('requester_shift_id', sa.String(50), sa.ForeignKey('shifts.id'), nullable=False),
        sa.Column('responder_shift_id', sa.String(50), sa.ForeignKey('shifts.id'), nullable=False),
