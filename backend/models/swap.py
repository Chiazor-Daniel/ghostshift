...
class SwapRequest(Base):
    ...
    responder_id = Column(String(50), ForeignKey("users.id", name="fk_swap_responder"), nullable=False)
    requester_shift_id = Column(String(50), ForeignKey("shifts.id", name="fk_swap_requester_shift"), nullable=False)
    responder_shift_id = Column(String(50), ForeignKey("shifts.id", name="fk_swap_responder_shift"), nullable=False)
